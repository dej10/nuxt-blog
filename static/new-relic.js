...
NREUM.loader_config = {
  ...
  trustKey: "3767458",
  agentID: "535900644",
  licenseKey: "NRJS-ad3b8b12d6b445aa7b4",
  applicationID: "535900644",
};
NREUM.info = {
...
window.NREUM || (NREUM = {}),
  (__nr_require = (function (t, e, n) {
    ...
    if (typeof __nr_require === "function") {
      return __nr_require;
    }
  ...
  })(
    {
          ...
          try {
            (o = localStorage.getItem("__nr_flags").split(",")),
              console &&
                ...
                ((s.console = !0),
                o.includes("dev") && (s.dev = !0),
                o.includes("nr_dev") && (s.nrDev = !0));
          } catch (c) {}
          s.nrDev &&
      ...
      5: [
        function (t, e, n) {
          ...
          if (
            ...
            const u = t(6);
            const d = t(23);
            var p = "learResourceTimings";
            const l = "addEventListener";
            var h = "removeEventListener";
            var m = "resourcetimingbufferfull";
            var v = "bstResource";
            var w = "resource";
            const g = "-start";
            const y = "-end";
      ...
      10: [
        function (t, e, n) {
          function r(t) {
            ...
            if (r) {
              ...
              if (o) {
                ...
                if (a) {
                  const d = s(a);
                  const p = typeof d.parent[d.key] === "function";
                  if (p) {
                    var l = {};
          ...
          var c = t(23);
          var f = t("ee").get("jsonp");
          var u = t("wrap-function")(f);
          if (((e.exports = f), o())) {
            var d = /[?&](?:callback|cb)=([^&#]+)/;
            var p = /(.*)\.([^.]+)/;
            var l = /^(\w+)(\.|$)(.*)$/;
            const h = ["appendChild", "insertBefore", "replaceChild"];
      ...
      16: [
        function (t, e, n) {
          function r(t) {
            ...
            const h = l.generateSpanId();
            const m = l.generateTraceId();
            const v = Date.now();
            const w = { spanId: h, traceId: m, timestamp: v };
            return (
              (t.sameOrigin || (c(t) && p())) &&
        ...
        function (t, e, n) {
          function r(t) {
            ...
            if (!this.ended) {
              ...
              return e.protocol && e.protocol === "data"
                ? void g("Ajax/DataUrl/Excluded")
                : void (
                    e.aborted ||
                    ((n.duration = a.now() - this.startTime),
                    this.loadCaptureCalled || t.readyState !== 4
          ...
          if (a.xhrWrappable && !a.disabled) {
            var s = t("handle");
            var c = t(18);
            const f = t(16).generateTracePayload;
            const u = t("ee");
            ...
            var v = t(19);
            const w = t(23);
            var g = t(25).recordSupportability;
            const y = NREUM.o.REQ;
            ...
            (a.features.xhr = !0),
              ...
              u.on("fetch-start", function (t, e) {
                ...
                if (
                  (typeof i === "string"
                    ? (n = i)
                    : typeof i === "object" && i instanceof y
                    ? (n = i.url)
                    : window.URL &&
                      typeof i === "object" &&
                      i instanceof URL &&
      ...
      20: [
        function (t, e, n) {
          ...
          var u = t(25);
          const d = NREUM;
          typeof window.newrelic === "undefined" && (newrelic = d);
          const p = [
            "setPageViewName",
            "setCustomAttribute",
            "setErrorHandler",
      ...
      25: [
        function (t, e, n) {
          function r(t, e) {
            const n = [a, t, { name: t }, e];
            return i("storeMetric", n, null, "api"), n;
          }
          function o(t, e) {
            const n = [s, t, { name: t }, e];
        ...
        function (t, e, n) {
          function r() {
            if (!T++) {
              ...
              t.agent.indexOf("http://") === 0 ||
              t.agent.indexOf("https://") === 0
                ? (r.src = t.agent)
                : (r.src = l + "://" + t.agent),
          ...
          const d = t(21);
          const p = t(23);
          var l = d.getConfiguration("ssl") === !1 ? "http" : "https";
          const h = window;
          var m = h.document;
          const v = "addEventListener";
          const w = "attachEvent";
